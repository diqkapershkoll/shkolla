...
import p6 from './../../images/panairi/p6.jpg';
import p7 from './../../images/panairi/p7.jpg';
import p8 from './../../images/panairi/p8.jpg';
import p9 from './../../images/panairi/p9.jpg';
import p10 from './../../images/panairi/p10.jpg';
import p11 from './../../images/panairi/p11.jpg';
import p12 from './../../images/panairi/p12.jpg';
import p13 from './../../images/panairi/p13.jpg';
export default class Panairi extends Component {
    render() {
        return (
            <div>
                <Navigation>
                            ...
                            <div id="demo" className="carousel slide" data-ride="carousel">
                                ...
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img src={p1} className={style.foto} ></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p2} className={style.foto} ></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p3} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p4} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p5} className={style.foto}></img>
                                    </div>
                                    

                                    <div className="carousel-item">
                                        <img src={p6} className={style.foto} ></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p7} className={style.foto} ></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p8} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p9} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p10} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p11} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p12} className={style.foto}></img>
                                    </div>

                                    <div className="carousel-item">
                                        <img src={p13} className={style.foto}></img>
                                    </div>
                                </div>
